...
return (
  <div>
    <div className="w-full h-full  p-8">
      ...
      <section className="w-[900px] m-auto  p-4 flex justify-center items-center">
        ...
        <div className="mb-6 ">
            ...
            <select name="" id="" value={newcategoria} onChange={(e)=>setNewCategoria(e.target.value)} >
              <option value="todos">Secos</option>
              <option value="cocina">Soft Drinks</option>
              <option value="barra">Jugos de frutas</option>
              <option value="barra">Lacteos</option>
              <option value="barra">Mezcladores</option>
              <option value="barra">Alcohol</option>
              <option value="barra">Produccion</option>
              <option value="barra">Papeleria</option>
              <option value="barra">Limpieza</option>
              <option value="barra">Packaging</option>
              <option value="barra">Edulcorante</option>
              <option value="barra">Siropes</option>
          ...
          <div className="mb-6">
            ...
            <select name="" id="" value={newcategoria} onChange={(e)=>setNewCategoria(e.target.value)} >
              <option value="todos">Litros</option>
              <option value="cocina">Kilos </option>
              <option value="barra">Gramos</option>
              <option value="barra">Onza</option>
